    ...
    <section className="relative bg-white pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[580px]">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-akzent-50 border border-akzent-100 rounded-full px-4 py-1.5 mb-6">
              <ShieldCheck className="w-4 h-4 text-akzent-700" />
              <span className="text-xs font-semibold text-akzent-800 uppercase tracking-wide">DSGVO · WCAG · Cookie Compliance</span>
            </div>

            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-[1.1] mb-6">
              Websites{' '}
              <span className="text-akzent-700">prüfen und reparieren</span>{' '}
              mit{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#scanner" className="inline-flex items-center justify-center gap-2 bg-akzent-800 hover:bg-akzent-900 text-white font-semibold px-6 py-3.5 rounded-xl transition-colors shadow-md shadow-akzent-100">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[520px]">
              <div className="absolute inset-0 bg-gradient-to-br from-akzent-200 to-akzent-100 rounded-3xl blur-2xl opacity-30 scale-95" />
