    ...
    <section className="relative bg-white pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[580px]">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-akzent-400 rounded-full px-4 py-1.5 mb-6">
              <ShieldCheck className="w-4 h-4 text-gray-900" />
              <span className="text-xs font-semibold text-gray-900 uppercase tracking-wide">DSGVO · WCAG · Cookie Compliance</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#scanner" className="inline-flex items-center justify-center gap-2 bg-akzent-400 hover:bg-akzent-500 text-gray-900 font-semibold px-6 py-3.5 rounded-xl transition-colors shadow-md shadow-akzent-100">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-gray-500">
              <span className="inline-flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-akzent-700" aria-hidden="true" />
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[520px]">
              <div className="absolute inset-0 bg-gradient-to-br from-akzent-400 to-akzent-200 rounded-3xl blur-2xl opacity-30 scale-95" />
