...
Reference full template: `/home/clawd/saas/legal/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/clawd/saas/legal/.claude/get-shit-done/templates/state.md`.
