"""
Complyo Backend - Production Ready
Vereintes Backend für alle Complyo Services
"""
import uvicorn
...
# Import our services
from stripe_service import stripe_service, PaymentRequest
...
if __name__ == "__main__":
    ...
    print("🛡️  Starting Complyo Production Backend")
    print(f"🚀 API Server: http://0.0.0.0:{port}")
    print(f"📖 API Documentation: http://0.0.0.0:{port}/docs")
    print("✨ All Complyo features available!")
