...
class WhiteLabelProcessor:
    ...
    def __init__(self):
        ...
        self.complyo_branding = {
            "footer": '<p class="complyo-attribution"><small>Erstellt mit <a href="https://complyo.de" target="_blank" rel="noopener">Complyo.tech</a> – Ihre Compliance-Plattform</small></p>',
    ...
    def _process_external_links(self, soup: BeautifulSoup) -> BeautifulSoup:
        ...
        for link in soup.find_all('a'):
            ...
            # Check if it's a third-party link (not complyo.de)
            if 'complyo.de' not in href.lower():
